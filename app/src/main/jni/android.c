...
void JNICALL Java_com_bgu_sherlock_Moriarty_GamePlay_keyEvent(JNIEnv *env, jobject _obj, jint x, jint y, jint keyval)
{
...
jfloat JNICALL Java_com_bgu_sherlock_Moriarty_GameView_suggestDensity(JNIEnv *env, jobject _view, jint viewWidth, jint viewHeight)
{
...
void JNICALL Java_com_bgu_sherlock_Moriarty_GamePlay_resizeEvent(JNIEnv *env, jobject _obj, jint viewWidth, jint viewHeight)
{
	pthread_setspecific(envKey, env);
	if (!fe || !fe->me) return;
...
void JNICALL Java_com_bgu_sherlock_Moriarty_GamePlay_timerTick(JNIEnv *env, jobject _obj)
{
...
void JNICALL Java_com_bgu_sherlock_Moriarty_GamePlay_configSetString(JNIEnv *env, jobject _obj, jstring name, jstring s)
{
	pthread_setspecific(envKey, env);
...
void JNICALL Java_com_bgu_sherlock_Moriarty_GamePlay_configSetBool(JNIEnv *env, jobject _obj, jstring name, jint selected)
{
	pthread_setspecific(envKey, env);
	config_item *i = configItemWithName(env, name);
...
void JNICALL Java_com_bgu_sherlock_Moriarty_GamePlay_configSetChoice(JNIEnv *env, jobject _obj, jstring name, jint selected)
{
	pthread_setspecific(envKey, env);
	config_item *i = configItemWithName(env, name);
	i->ival = selected;
...
void JNICALL Java_com_bgu_sherlock_Moriarty_GamePlay_solveEvent(JNIEnv *env, jobject _obj)
{
	pthread_setspecific(envKey, env);
...
void JNICALL Java_com_bgu_sherlock_Moriarty_GamePlay_restartEvent(JNIEnv *env, jobject _obj)
{
	pthread_setspecific(envKey, env);
	midend_restart_game(fe->me);
}

void JNICALL Java_com_bgu_sherlock_Moriarty_GamePlay_configEvent(JNIEnv *env, jobject _obj, jint whichEvent)
{
	pthread_setspecific(envKey, env);
	char *title;
	config_item *i;
...
jstring JNICALL Java_com_bgu_sherlock_Moriarty_GamePlay_configOK(JNIEnv *env, jobject _obj)
{
	pthread_setspecific(envKey, env);
	char *encoded;
...
jstring JNICALL Java_com_bgu_sherlock_Moriarty_GamePlay_getFullGameIDFromDialog(JNIEnv *env, jobject _obj)
{
	return getDescOrSeedFromDialog(env, _obj, CFG_DESC);
}

jstring JNICALL Java_com_bgu_sherlock_Moriarty_GamePlay_getFullSeedFromDialog(JNIEnv *env, jobject _obj)
{
	return getDescOrSeedFromDialog(env, _obj, CFG_SEED);
}

void JNICALL Java_com_bgu_sherlock_Moriarty_GamePlay_configCancel(JNIEnv *env, jobject _obj)
{
	pthread_setspecific(envKey, env);
	free_cfg(fe->cfg);
	fe->cfg = NULL;
...
void JNICALL Java_com_bgu_sherlock_Moriarty_GamePlay_serialise(JNIEnv *env, jobject _obj)
{
	if (!fe) return;
	pthread_setspecific(envKey, env);
...
jint JNICALL Java_com_bgu_sherlock_Moriarty_GamePlay_identifyBackend(JNIEnv *env, jclass c, jstring savedGame)
{
	pthread_setspecific(envKey, env);
	return deserialiseOrIdentify(NULL, savedGame, TRUE);
}

jstring JNICALL Java_com_bgu_sherlock_Moriarty_GamePlay_getCurrentParams(JNIEnv *env, jobject _obj)
{
...
jstring JNICALL Java_com_bgu_sherlock_Moriarty_GamePlay_htmlHelpTopic(JNIEnv *env, jobject _obj)
{
	//pthread_setspecific(envKey, env);
...
void JNICALL Java_com_bgu_sherlock_Moriarty_GamePlay_requestKeys(JNIEnv *env, jobject _obj, jstring jBackend, jstring jParams)
{
	pthread_setspecific(envKey, env);
...
void JNICALL Java_com_bgu_sherlock_Moriarty_GamePlay_setCursorVisibility(JNIEnv *env, jobject _obj, jboolean visible)
{
	if (!fe || !fe->me) return;
	pthread_setspecific(envKey, env);
...
jfloatArray JNICALL Java_com_bgu_sherlock_Moriarty_GameView_getColours(JNIEnv *env, jobject _obj)
{
	int n;
	float* colours;
...
jobjectArray JNICALL Java_com_bgu_sherlock_Moriarty_GamePlay_getPresets(JNIEnv *env, jobject _obj)
{
...
jint JNICALL Java_com_bgu_sherlock_Moriarty_GamePlay_getUIVisibility(JNIEnv *env, jobject _obj) {
...
void JNICALL Java_com_bgu_sherlock_Moriarty_GamePlay_startPlaying(JNIEnv *env, jobject _obj, jobject _gameView, jstring savedGame)
{
	startPlayingInt(env, _obj, _gameView, NULL, savedGame, FALSE);
}

void JNICALL Java_com_bgu_sherlock_Moriarty_GamePlay_startPlayingGameID(JNIEnv *env, jobject _obj, jobject _gameView, jstring backend, jstring gameID)
{
...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM *jvm, void *reserved)
{
	...
	pthread_setspecific(envKey, env);
	cls = (*env)->FindClass(env, "com/bgu/sherlock/Moriarty/GamePlay");
	vcls = (*env)->FindClass(env, "com/bgu/sherlock/Moriarty/GameView");
	arrowModeCls = (*env)->FindClass(env, "com/bgu/sherlock/Moriarty/SmallKeyboard$ArrowMode");
	ARROW_MODE_NONE = (*env)->NewGlobalRef(env, (*env)->GetStaticObjectField(env, arrowModeCls,
			(*env)->GetStaticFieldID(env, arrowModeCls, "NO_ARROWS", "Lcom/bgu/sherlock/Moriarty/SmallKeyboard$ArrowMode;")));
	ARROW_MODE_ARROWS_ONLY = (*env)->NewGlobalRef(env, (*env)->GetStaticObjectField(env, arrowModeCls,
			(*env)->GetStaticFieldID(env, arrowModeCls, "ARROWS_ONLY", "Lcom/bgu/sherlock/Moriarty/SmallKeyboard$ArrowMode;")));
	ARROW_MODE_ARROWS_LEFT_CLICK = (*env)->NewGlobalRef(env, (*env)->GetStaticObjectField(env, arrowModeCls,
			(*env)->GetStaticFieldID(env, arrowModeCls, "ARROWS_LEFT_CLICK", "Lcom/bgu/sherlock/Moriarty/SmallKeyboard$ArrowMode;")));
	ARROW_MODE_ARROWS_LEFT_RIGHT_CLICK = (*env)->NewGlobalRef(env, (*env)->GetStaticObjectField(env, arrowModeCls,
			(*env)->GetStaticFieldID(env, arrowModeCls, "ARROWS_LEFT_RIGHT_CLICK", "Lcom/bgu/sherlock/Moriarty/SmallKeyboard$ArrowMode;")));
	ARROW_MODE_DIAGONALS = (*env)->NewGlobalRef(env, (*env)->GetStaticObjectField(env, arrowModeCls,
			(*env)->GetStaticFieldID(env, arrowModeCls, "ARROWS_DIAGONALS", "Lcom/bgu/sherlock/Moriarty/SmallKeyboard$ArrowMode;")));
	...
	setKeys        = (*env)->GetMethodID(env, cls,  "setKeys",
			"(Ljava/lang/String;Ljava/lang/String;Lcom/bgu/sherlock/Moriarty/SmallKeyboard$ArrowMode;)V");
